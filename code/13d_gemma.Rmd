...
# windows SUCKS so I cannot work with long filenames on the nas.
#knitr::opts_knit$set(root.dir = "/home/marta/doc/hybrids_peaxiINV_RMD/")
#knitr::opts_chunk$set(root.dir = "/home/marta/doc/hybrids_peaxiINV_RMD/")

knitr::opts_knit$set(root.dir = "/media/ipsnas/Groups/Deve/Current lab members/marta/hybrids_peaxiINV/")
knitr::opts_chunk$set(root.dir = "/media/ipsnas/Groups/Deve/Current lab members/marta/hybrids_peaxiINV/")
source("/media/ipsnas/Groups/Deve/Current lab members/marta/hybrids_peaxiINV/code/13_gwas_functions.R")
```
...
```{r}
basenames <- c("hardfiltered_biallelic_cr09_mm005_pheno3_bslmm1",
               "hardfiltered_biallelic_cr09_mm005_pheno4_bslmm1",
               "hardfiltered_biallelic_cr09_mm005_pheno5_bslmm1")
```
...
```{r lm4_pheno5}
basename <- "hardfiltered_biallelic_cr09_mm005_pheno5_lm4"
assoc_df <- read.table(paste0("data/raw/gwas/output/", basename, ".assoc.txt"),
                    header = T,
                    as.is = "rs")
# choose p value test
...
qq <- function() {myqqplot(assoc_df, p = p, paste0(basename, "_", p))}
mh <- function() {manhattan(assoc_df, pval = p, paste0(basename, "_", p), 0.05, correct = TRUE)}
png(paste0("figures/exploratory/gwas/plot_qq_manhattan_lm_pheno5_", p, ".png"),
    width = 1600, height = 300)
layout(matrix(c(1,2,2), 1, 3, byrow = TRUE))
qq()
mh()
...
```{r lmm4_pheno5}
basename <- "hardfiltered_biallelic_cr09_mm005_pheno5_lmm4"
assoc_df <- read.table(paste0("data/raw/gwas/output/", basename, ".assoc.txt"),
                    header = T,
                    as.is = "rs")
# choose p value test
...
qq <- function() {myqqplot(assoc_df, p = p, paste0(basename, "_", p))}
mh <- function() {manhattan(assoc_df, pval = p, paste0(basename, "_", p), 0.05, correct = TRUE)}
png(paste0("figures/exploratory/gwas/plot_qq_manhattan_lmm_pheno5_", p, ".png"),
    width = 1600, height = 300)
layout(matrix(c(1,2,2), 1, 3, byrow = TRUE))
qq()
mh()
